...
OCP_HUB_API=https://api.argo-hub.sandboxXXXX.opentlc.com:6443
OCP_HUB_CONSOLE=https://console-openshift-console.apps.argo-hub.sandboxXXXX.opentlc.com
OCP_SNO_API=https://api.sno-XX.sandboxXXXX.opentlc.com:6443
OCP_SNO_CONSOLE=https://console-openshift-console.apps.sno-XX.sandboxXXXX.opentlc.com
----
...
- Insert user _admin_ and _redhat_ provided by instructor and click *_Log in_* button.
