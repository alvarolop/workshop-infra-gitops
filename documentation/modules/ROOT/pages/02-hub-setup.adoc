...
Let's start logging in to *_Argo Hub_* cluster:

IMPORTANT: Replace XX values of the *_OCP_USER_*, *_OCP_SNO_API_*, and *_OCP_SNO_CONSOLE_* with the values provided by the instructor at the beginning of this workshop.
