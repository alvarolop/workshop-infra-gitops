...
You should see a `range` loop like this:
...
IMPORTANT: As prerequisite make sure you have deployed the *Vault application* listed in section *_3.4 Creating your first ArgoCD Apps application_*.
    ...
    initContainers: # init container
      - args:
          - >-
            ...
            https://github.com/argoproj-labs/argocd-vault-plugin/releases/download/v$AVP_VERSION/argocd-vault-plugin_$AVP_VERSION_linux_amd64
...
NOTE: This modification applies to *Vault application* deployed at the end of *_3.4 Creating your first ArgoCD Apps application_*.
